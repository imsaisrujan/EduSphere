...
// Fetch the student's details including Room_ID and Student_ID
$student_query = "SELECT Student_ID, Room_ID FROM STUDENT WHERE Username = ?";
...
if ($result->num_rows > 0) {
    ...
    $room_id = $student_details['Room_ID'];
} else {
...
// Fetch the student's maintenance requests
$requests_query = "SELECT * FROM MAINTENANCE_REQUEST WHERE Student_ID = ?";
    ...
    <div class="container">
        <div class="sidebar">
            ...
            <ul>
                ...
                <li><a href="./MaintenanceRequest.php" class="active">Maintenance Requests</a></li>
        ...
        <div class="main-content">
            ...
            <div class="card">
                ...
                <form action="add_request.php" method="post">
                    ...
                    <input type="number" id="room_id" name="room_id" value="<?php echo htmlspecialchars($room_id); ?>" readonly>
                    <label for="student_id">Student ID:</label>
                    <input type="number" id="student_id" name="student_id" value="<?php echo htmlspecialchars($student_id); ?>" readonly>
